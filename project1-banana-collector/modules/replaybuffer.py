...
class ReplayBuffer:
    ...
    def __init__(self, 
        ...
        ======
            ...
            activatePrioritizedExperienceReplay (boolean): true, if prioritized exxperience activate
        """
    ...
    def sample(self):
        ...
        actions = torch.from_numpy(np.vstack([e[1] for e in experiences if e is not None])).long().to(self._device)
